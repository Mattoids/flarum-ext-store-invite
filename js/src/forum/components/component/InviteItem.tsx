    ...
    return m('div.Invite-Body' + this.class , [
      m('.Form-group', [
        ...
        m('div.spacing', [
          ...
          m('span', this.inviteData.totalNum || 0),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-pass-total-num') + ': '),
          m('span', this.inviteData.passTotalNum || 0),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-reject-total-num') + ': '),
          m('span', this.inviteData.totalRejectlNum || 0),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-user-create-time') + ': '),
          m('span', this.inviteData.userCreateTime),
        ]),
        m('div.spacing', [
          m('label', app.translator.trans('mattoid-store-invite.lib.item-last-year-pass-num') + ': '),
          m('span', this.inviteData.lastYearPass || 0),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-last-year-reject-num') + ': '),
          m('span', this.inviteData.lastYearApply - this.inviteData.lastYearPass),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-this-year-pass-num') + ': '),
          m('span', this.inviteData.thisYearPass || 0),
          m('span.horizontal-spacing', ' | '),
          m('label', app.translator.trans('mattoid-store-invite.lib.item-this-year-reject-num') + ': '),
          m('span', this.inviteData.thisRejectlNum || 0),
        ]),
        m('div.spacing', [
